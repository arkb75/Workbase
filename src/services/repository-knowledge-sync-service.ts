...
export const REPOSITORY_STATIC_ANALYZER_VERSION = "repository-coverage-v18-hybrid";
export const REPOSITORY_SEMANTIC_ANALYZER_VERSION = "repository-coverage-v20-hybrid";
