...
export const REPOSITORY_STATIC_ANALYZER_VERSION = "repository-coverage-v23-hybrid";
export const REPOSITORY_SEMANTIC_ANALYZER_VERSION = "repository-coverage-v35-hybrid";
