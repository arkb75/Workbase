...
describe("latest-commit freshness barrier", () => {
  ...
  it("invalidates same-head refresh reuse when any knowledge policy is stale", () => {
    ...
    const currentWarnings = {
      analyzerVersion: "repository-coverage-v20-hybrid",
      semanticAnalyzerVersion: "repository-coverage-v21-hybrid",
      coveragePolicyVersion: "repository-coverage-v12-hybrid",
      orchestrationPolicyVersion: "repository-orchestration-v17-hybrid",
      synthesisPolicyVersion: "repository-synthesis-v35-hybrid",
