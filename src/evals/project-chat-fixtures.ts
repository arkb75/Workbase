...
export const projectChatEvaluationFixtures = [
  {
    ...
    expected: {
      ...
      lifecycle: ["answered"],
      requiredTools: [],
      forbiddenTools: ["refresh_project_knowledge"],
  ...
  },
  {
    ...
    expected: {
      ...
      requiredTools: ["refresh_project_knowledge"],
      forbiddenTools: [],
      allowedSourceKinds: durableMemorySources,
  ...
  },
  {
    ...
    expected: {
      ...
      lifecycle: ["answered"],
      requiredTools: [],
      forbiddenTools: ["inspect_prior_turn"],
      allowedSourceKinds: durableMemorySources,
      requiredSourceKinds: ["project_fact"],
      allowedAuthorities: durableMemoryAuthorities,
