...
export const repositoryKnowledgeFixtures = [
  ...
  },
  {
    ...
    expectedCapabilities: [
      ...
      capability({ key: "proposal_pdf_generation", label: "Proposal PDF generation", domainKey: "proposals", matchPatterns: ["proposal.{0,35}(?:pdf|render|document)|pdf.{0,35}(?:proposal|render|generat)"], evidencePathPatterns: ["pdf_generator\\.py|doc-service/lambda/src/template-handler\\.js"], exampleClaim: "Generated rendered proposal PDFs from structured project requirements." }),
      ...
      capability({ key: "human_review", label: "Human approval workflow", domainKey: "quality", importance: "supporting", matchPatterns: ["human.{0,35}(?:review|approval|loop)|approve.{0,25}reject.{0,25}edit|pending.{0,30}repl(?:y|ies).{0,35}(?:approv|reject|amend|edit)"], evidencePathPatterns: ["frontend/email-intake/src/components/(?:ReplyEditor|ConversationDetail)\\.tsx|frontend/email-intake/src/api/client\\.ts|email_intake/api/lambda_api\\.py"], exampleClaim: "Added human approve, reject, and edit controls around generated work." }),
